...
public class ChallengeChairRuleML2008 extends HttpServlet {
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Challenge Chair Servlet RuleML-2008");
    out.println("Challenge Chair Servlet RuleML-2008");
	...
	String date;	
 	...
 	System.out.println("Challenge Chair Servlet Console update:");
 ...
 /////////////////////////
    ...
    throws ServletException, IOException
  {
    ...
    try
    {	   	
    	System.out.println("Challenge Chair Servlet");
...
//	BackwardReasoner br = new BackwardReasoner();
 ...
 //   SymbolTable.reset();
   ...
   // String contents = "c(a).\nc(b).\nc(c).";
	...
	String url = "http://www.jdrew.org/oojdrew/ruleSetsRuleML-2008/challengeChairRuleML-2008.posl";
   ...
   try {
    ...
    while(solit.hasNext()) {
		...
		MessageGenerator g = new MessageGenerator(data,varSize,"ruleml2008_ChallengeChair",m.getId(),m.getProtocol(), m.getRel());
    ...
    MessageGenerator g = new MessageGenerator(null,varSize,"ruleml2008_ChallengeChair",m.getId(),m.getProtocol(), m.getRel());
