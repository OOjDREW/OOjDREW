...
public class PaperSubmittal extends HttpServlet {
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Paper Submittal Servlet");
    out.println("Paper Submittal Servlet");
 ...
 /////////////////////////
    ...
    throws ServletException, IOException
  {
    ...
    try
    {	   	
    	System.out.println("Connected to Paper Submittal Servlet");
 ...
 //   SymbolTable.reset();
   ...
   // String contents = "c(a).\nc(b).\nc(c).";
	...
	System.out.println(time);	
   	String url = "http://www.jdrew.org/oojdrew/paperSubmittal2.posl";
