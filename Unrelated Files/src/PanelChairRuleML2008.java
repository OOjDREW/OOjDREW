...
public class PanelChairRuleML2008 extends HttpServlet {
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Panel Chair Servlet RuleML-2008");
    out.println("Panel Chair Servlet RuleML-2008");
...
//	BackwardReasoner br = new BackwardReasoner();
 ...
 //   SymbolTable.reset();
   ...
   // String contents = "c(a).\nc(b).\nc(c).";
	...
	String url = "http://www.jdrew.org/oojdrew/ruleSetsRuleML-2008/panelChairRuleML-2008.posl";
   ...
   try {
    ...
    while(solit.hasNext()) {
		...
		MessageGenerator g = new MessageGenerator(data,varSize,"ruleml2008_PanelChair",m.getId(),m.getProtocol(), m.getRel());
    ...
    MessageGenerator g = new MessageGenerator(null,varSize,"ruleml2008_PanelChair",m.getId(),m.getProtocol(), m.getRel());
