...
public class OOjDREW3 extends HttpServlet {
 ...
 /////////////////////////
    ...
    throws ServletException, IOException
  {
    ...
    try
    {	   	
    	System.out.println("OO jDREW3 Connected");
   ...
   try {
    ...
    int varSize = 0;
        ...
        MessageGenerator g = new MessageGenerator(data,varSize,"OOjDrewAgent3",m.getId(),m.getProtocol(), m.getRel());
            
        messages = g.Messages();
        
        String appender = "";
        
        URL sender = new URL("http://10.1.3.4:8889");
