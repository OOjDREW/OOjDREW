...
public class programChair2 extends HttpServlet {
 ...
 /////////////////////////
    ...
    throws ServletException, IOException
  {
    ...
    try
    {	   	
    	System.out.println("Connected to Program Chair 2");
   ...
   try {
    ...
    int varSize = 0;
        ...
        MessageGenerator g = new MessageGenerator(data,varSize,"programChair2",m.getId(),m.getProtocol(), m.getRel());
