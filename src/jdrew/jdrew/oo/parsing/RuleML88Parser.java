...
public class RuleML88Parser implements IRuleMLParser {
    ...
    private RuleMLTagNames tagNames;
    ...
    public RuleML88Parser(Vector clauses) {
        ...
        this.tagNames = new RuleMLTagNames(RuleMLVersion.RuleML88);
    }
    ...
    public void parseRuleMLDocument(Document doc) throws ParseException {
        ...
        Element and = root.getFirstChildElement(tagNames.AND);
        if (and == null) {
            throw new ParseException(
    ...
    private Term parseData(Element data) throws ParseException {
      ...
      //Attribute type = data.getAttribute(tagNames.XSITYPE,"http://www.w3.org/2001/XMLSchema-instance");
