 ...
 *
 * The call format is cos(?result, input:Real).
 *
 * <p>Title: OO jDREW</p>
 *
 ...
 * @version 0.89
 */
public class CosBuiltin implements Builtin {
    private int symbol = SymbolTable.internSymbol("cos");
