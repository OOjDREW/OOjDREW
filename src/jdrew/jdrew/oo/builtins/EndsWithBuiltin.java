 ...
 * 
 * Calling format endsWith(?input1, input2)
 * 
 ...
 * @version 0.89
 */
public class EndsWithBuiltin implements Builtin {
    private int symbol = SymbolTable.internSymbol("endsWith");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-endswith-" + p1s
                                                      + "-" + p2s),
