 ...
 *
 * The call format is mod(?remainder, dividend, divisor).
 * 
 *<p>Title: OO jDREW</p>
 *
 ...
 * @version 0.89
 */
public class ModBuiltin implements Builtin {
    private int sym = SymbolTable.internSymbol("mod");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-mod-"
                                                      + p2s + "%" + p3s),
