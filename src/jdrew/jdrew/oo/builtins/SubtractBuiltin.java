 ...
 *
 * The call format is subract(?result,minuend, subtrahend).
 *
 * <p>Title: OO jDREW</p>
 *
 ...
 * @version 0.89
 */
public class SubtractBuiltin implements Builtin {
    private int sym = SymbolTable.internSymbol("subtract");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-subtract-"
                                                      + p2s + "-" + p3s),
