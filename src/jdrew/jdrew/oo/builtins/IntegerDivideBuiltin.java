 ...
 * @version 0.89
 */
public class IntegerDivideBuiltin implements Builtin {
    private int sym = SymbolTable.internSymbol("integerDivide");
    ...
    public DefiniteClause buildResult(Term t) {
        ...
        Term roid = new Term(SymbolTable.internSymbol("$jdrew-idivide-"
                                                      + p2s + "//" + p3s),
