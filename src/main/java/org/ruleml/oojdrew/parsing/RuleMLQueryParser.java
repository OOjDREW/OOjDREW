...
public class RuleMLQueryParser {
    ...
    public void parseRuleMLDocument(Document doc) throws ParseException {
        ...
        if (!root.getLocalName().equals(tagNames.QUERY)) {
    ...
    private Vector parseImplies(Element implies, boolean newVarnames) throws
        ...
        if (body.getLocalName().equals(tagNames.ATOM)) {
        ...
        } else if (body.getLocalName().equals(tagNames.QUERY)) {
            ...
            for (int i = 0; i < els.size(); i++) {
                ...
                } else if (el.getLocalName().equals(tagNames.QUERY)) {
